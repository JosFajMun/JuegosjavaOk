...
public class Tute extends Juego {
    ...
    private final int NUMERO_CARTAS_MANO = 4;
    ...
    public Tute() {
        ...
        this.rondaActual = 1;
        this.triunfo = baraja.sacarCarta();
    }
    ...
    private void jugarRonda() {
        ...
        for (int i = 0; i < NUMERO_CARTAS_MANO; i++) {
            ...
            int ganadorMano = compararCartas(cartaEquipo1, cartaEquipo2, triunfo);
    ...
    private int compararCartas(Carta carta1, Carta carta2, Carta triunfo) {
        int valorCarta1 = carta1.getValor7yMedio();
        int valorCarta2 = carta2.getValor7yMedio();

        if (carta1.getPalo().equals(triunfo.getPalo())) {
            valorCarta1 *= 2;
        }

        if (carta2.getPalo().equals(triunfo.getPalo())) {
            valorCarta2 *= 2;
        }
